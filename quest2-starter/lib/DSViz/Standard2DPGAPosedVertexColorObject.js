...
import SceneObject from "quest2-starter/lib/DSViz/SceneObject.js"
...
export default class Standard2DPGAPosedVertexColorObject extends SceneObject {
  ...
  async createGeometry() {
    ...
    console.log('Here');
    console.log(this._vertices.byteLength);
  ...
  async createShaders() {
    let shaderCode = await this.loadShader("quest2-starter/shaders/standard2dpgacolored.wgsl");
